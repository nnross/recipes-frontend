 ...
 * @returns Header.
 */
const Header = ({ className, id, openLogin }) => {
  const openNav = () => {
  ...
  return (
    <header className={className} id={id}>
      <div className={`${className}__nav`} id={`${id}__nav`}>
        ...
        <div className={`${className}__nav__icon`} />
        <nav className={`${className}__nav__sidebar`} id={`${id}__nav__sidebar`}>
          ...
          <a className={`${className}__nav__sidebar__search`} href="/all"> search </a>
          <a className={`${className}__nav__sidebar__settings`} href="/settings"> personal </a>
          <button className={`${className}__nav__sidebar__logout`} type="button"> log out </button>
        </nav>
      </div>
